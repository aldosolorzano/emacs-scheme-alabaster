...
(let ((selection-color (if (featurep 'ns) "ns_selection_color" "#B4D8FD"))
      (highlight-color "#FFFABC")
  ...
  (custom-theme-set-faces
   ...
   '(blue ((t (:foreground "#DBF1FF"))))
   '(bold ((t (:bold t))))
   '(bold-italic ((t (:italic t :bold t))))
   '(border-glyph ((t (nil))))
   '(green ((t (:foreground "#F1FADF"))))
   ...
   '(yellow ((t (:foreground "#FFFABC"))))

   ;; Frame
   '(fringe ((t (:background "#f7f7f7"))))
   `(mode-line ((t (:background "#e8e8e8" :foreground "#00040a"
   ...
   `(text-cursor ((t (:background "#00040a" :foreground ,passive-color))))
   ...
   '(font-lock-constant-face ((t (:foreground "#00040a" :background "#F3F2FF"))))
   '(font-lock-doc-string-face ((t (:foreground "#1A93AE" :background "#F4F9FE"))))
   '(font-lock-function-name-face ((t (:foreground "#00040a" :background "#DBF1FF"))))
   '(font-lock-keyword-face ((t (:foreground "#303761"))))
   '(font-lock-preprocessor-face ((t (:foreground "#434343"))))
   '(font-lock-reference-face ((t (:foreground "#4E279A" :background "#F3F2FF"))))
   '(font-lock-string-face ((t (:foreground "#00040a" :background "#F1FADF"))))
   '(font-lock-type-face ((t (:foreground "#49751c"))))
   '(font-lock-variable-name-face ((t (:foreground "#00040a" :background "#DBF1FF")))) ;;for defs
   ...
   '(magit-item-highlight ((t (:background nil :foreground "#00040a"))))
